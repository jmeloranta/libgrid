...
__global__ void grid_cuda_wf_propagate_kinetic_fft_gpu(CUCOMPLEX *b, CUREAL norm, CUREAL cx, CUREAL cy, CUREAL cz, CUREAL kx0, CUREAL ky0, CUREAL kz0, CUREAL maxk, CUCOMPLEX time_mass, INT nx, INT ny, INT nz, INT nx2, INT ny2, INT nz2) {  /* Exectutes at GPU */
...
extern "C" void grid_cuda_wf_propagate_kinetic_fftW(CUCOMPLEX *grid, CUREAL norm, CUREAL kx0, CUREAL ky0, CUREAL kz0, CUREAL step, CUCOMPLEX time_mass, INT nx, INT ny, INT nz) {
  ...
  grid_cuda_wf_propagate_kinetic_fft_gpu<<<blocks,threads>>>(grid, norm, cx, cy, cz, kx0, ky0, kz0, M_PI / step, time_mass, nx, ny, nz, nx2, ny2, nz2);
  cuda_error_check();
}
...
__global__ void grid_cuda_wf_propagate_kinetic_cfft_gpu(CUCOMPLEX *b, CUREAL norm, CUREAL cx, CUREAL cy, CUREAL cz, CUREAL kx0, CUREAL ky0, CUREAL kz0, CUREAL maxk, CUCOMPLEX time_mass, INT nx, INT ny, INT nz, INT nx2, INT ny2, INT nz2) {  /* Exectutes at GPU */
...
extern "C" void grid_cuda_wf_propagate_kinetic_cfftW(CUCOMPLEX *grid, CUREAL norm, CUREAL kx0, CUREAL ky0, CUREAL kz0, CUREAL step, CUCOMPLEX time_mass, INT nx, INT ny, INT nz) {
  ...
  grid_cuda_wf_propagate_kinetic_cfft_gpu<<<blocks,threads>>>(grid, norm, cx, cy, cz, kx0, ky0, kz0, M_PI / step, time_mass, nx, ny, nz, nx2, ny2, nz2);
  cuda_error_check();
}
