...
EXPORT char grid_func1_cuda_operate_one(rgrid *dst, rgrid *src, REAL xi, REAL rhobf) {
  ...
  grid_func1_cuda_operate_oneW(cuda_find_block(dst->value), cuda_find_block(src->value), xi, rhobf, dst->nx, dst->ny, dst->nz);
...
EXPORT char grid_func1_cuda_operate_one_product(rgrid *dst, rgrid *src1, rgrid *src2, REAL xi, REAL rhobf) {
  ...
  grid_func1_cuda_operate_one_productW(cuda_find_block(dst->value), cuda_find_block(src1->value), cuda_find_block(src2->value), xi, rhobf, dst->nx, dst->ny, dst->nz);
  return 0;
}
#endif
