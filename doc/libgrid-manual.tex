...
\include{real-functions}

\section{Complex grid routines}

\include{complex-functions}

\section{Mixed grid routines}

\include{mixed-functions}

\section{Wavefunction routines}

\include{wf-functions}
...
\include{linalg-functions}

\section{Interpolation routines}

\include{interpolate-functions}
